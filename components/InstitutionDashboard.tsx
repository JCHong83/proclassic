...
{ id: "org_op_1", title: "Chorus auditions", type: "audition", location: "Florence", roleTags: ["Chorus"], level: "amateur", deadline: "2025-09-28", payRange: "€0-€100", applicants: [{ id: "a1", name: "Marco", profileSummary: "Tenor" }] },
]);
...
<button className="border px-3 py-1 rounded">Applicants ({op.applicants.length})</button>
</div>
))}
</div>
);
